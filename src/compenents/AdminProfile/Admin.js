...
import bannerImg from '../../assets/banneradmin.jpg';
import './Admin.css';
      ...
      <div className="admin-profile-content">
        <div className="admin-glass-card">
          ...
          <div className="admin-profile-details">
            <p><span className="admin-label">Name:</span> {user.userName || user.name}</p>
            <p><span className="admin-label">Email:</span> {user.email}</p>
            <p><span className="admin-label">Phone:</span> {user.phone || '-'}</p>
            <p><span className="admin-label">Bio:</span> {user.bio || '-'}</p>
            <p><span className="admin-label">Role:</span> {user.role}</p>
          </div>
        </div>
